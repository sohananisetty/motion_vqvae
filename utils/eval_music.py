...
def evaluate_music_motion_generative(
	val_loader, vqvae_model,net,audio_feature_dir = "/srv/scratch/sanisetty3/music_motion/AIST/audio_features", audio_encoding_dir = "/srv/scratch/sanisetty3/music_motion/AIST/music",
	best_fid_k=1000,best_fid_g=1000,
	best_div_k=-100, best_div_g=-100,
	best_beat_align=-100):
