...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', default="./checkpoints/vanilla")
    parser.add_argument('--evaluate', action='store_true')
    parser.add_argument('--seed', default=42, type=int)
    parser.add_argument('--fp16', default=True, type=bool)
    parser.add_argument("--dataset_name", type=str, default='t2m', help="t2m or kit")


    parser.add_argument('--train_bs', default=96, type=int,)
    parser.add_argument('--eval_bs', default=96, type=int,)
